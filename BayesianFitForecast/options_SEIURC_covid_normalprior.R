...
calibrationperiods <- c(25,30,35,40,45,50)
...
ode_system <- '
  ...
  diff_var3 = params3 * params4 * vars2 - params2 * vars3
  diff_var4 = params3 * (1-params4) * vars2 - params2 * vars4
  diff_var5 = params2 * (vars3 + vars4)
  diff_var6 = params2 * params4 * vars3'

# Indicate if a parameter is fixed
paramsfix <- c(0,1,1,0,1)
...
params1_prior <- "normal(2, 1)T[0,]"
params2_prior <- 1
params3_prior <- 1
params4_prior <- "uniform(0, 1)"
params5_prior <- 47332614

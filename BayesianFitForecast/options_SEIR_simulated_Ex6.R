...
# N: fixed population size 100,000
...
cadfilename1 <- "curve-SEIR_plain_I-dRdt-dCdt-dist1-0-factor1-5"

# string indicating the name of the disease related to the time series data
caddisease <- "simulated"

series_cases <- c("infectious prevalence","recovery flow","reported incidence")
